...
uses DataModulo, uFuncionario, uDependente, System.MaskUtils;
...
begin
  ...
  begin
    ...
    try
      ...
      vFuncionario.IDFuncionario := dm.qryFuncionarioID.AsInteger;
      vFuncionario.Apagar;
    finally
      vFuncionario.Free;
    end;
...
begin
  uCadastroDependente.AbrirTela(dm.qryFuncionarioID.AsInteger);
  ListarDependentes;
  CalcularImpostos;
end;
...
begin
  ...
  try
    mmo.Clear;
    for vDependente in vFuncionario.AdicionarDependenteList(dm.qryFuncionarioID.AsInteger) do
    begin
