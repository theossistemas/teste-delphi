...
{ Cálculo de INSS e IR aplicado ao funcionário usando o valor do salário como base.
	* Regras de negócio
		* INSS - O cálculo de INSS será descontado 8%
      do valor do funcionário caso o dependente calcula INSS
           //   Comentário: Se o dependente nao calula INSS fica isento? Assumo essa condição para o teste
 * Ex. Funcionário que ganha 1000,00 e que tenha dois dependentes
    * INSS = 1000,00 – 8% = 80,00   //   Comentários: INSS = (SalarioBase) * 8%
}
